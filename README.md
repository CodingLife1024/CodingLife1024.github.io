...
💻 Systems engineer • Network explorer • Hardware tinkerer • Code poet  

I like building things that *just work* — whether that's firmware on a tiny embedded device, a network analyzer running in the background, or a clean web interface you can navigate without friction. I've spent the last few years moving across the stack: from assembly and bare metal to React dashboards and ML models.  

Right now, I'm in the early-career stage: applying what I learned at IIT Delhi to real-world systems while exploring my long-term interest in **climate sciences and data-driven modeling**. I'm especially curious about projects at the intersection of **AI, ML, and environmental science** — using data analytics to understand, predict, and maybe even help solve climate challenges. 🌍  
...
- 🌐 Web apps with clean design and functional logic  
- 🧠 ML models, ranking systems, and optimizations that actually converge  
- 📊 Dashboards, visualizations, and logs that tell a story at a glance  
- 🌱 Early work in climate-focused data analytics (where I'm looking for more projects!)  

I care about performance, reliability, and simplicity — and I'll happily spend an extra day making sure a system doesn't just *run*, but runs **beautifully**.
